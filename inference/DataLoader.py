...
augmentations = [flip_0, flip_1, flip_2, flip_0_1, flip_0_2, flip_1_2, flip_0_1_2]
            ...
            for file_name in os.listdir(anat_folder_path):
                if file_name.endswith('_acq-standard_T1w.nii.gz'): 
                    ...
                    for modification in modifications:
                        ...
                        ground_truth_labels.loc[len(ground_truth_labels)] = [id, gt_score] # TODO store ID with temporaryDir

                        # 2 - Temporarly save the image so it can be re-loaded with nib library
                        temp_path = os.path.join(TemporaryDir, f"{id}_T1W.nii.gz")
